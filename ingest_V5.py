...
from cleanCSVXero import cleanXeroCSVfile as cxf
from PGxeroConnect import pgConn
from readFidelity import readPositions

xeroDB = 'transaction_detailed'
    ...
    if app == 'xero':
        ...
        try:
            ...
            for li in CSVxClean:
                ...
                if li not in pglClean:
                    ...
                    if not dry_run:
                        try:
                            postgres_insert_query = """ INSERT INTO """+xeroDB+""" (acct_code, acct_name, trans_date, trans_type, trans_des, trans_ref, trans_gross, trans_tax, trans_net, trans_tax_rate, trans_tax_name) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"""
                            # test
                            ...
                            print("Error 38 inserting into transaction_detailed table", ddb)
                            sys.exit(38)
            if not dry_run:
        ...
        try:
            ...
            cur2.execute("select acct_code, acct_name, trans_date, trans_type, trans_des, trans_ref, trans_gross, \
                trans_tax, trans_net, trans_tax_rate, trans_tax_name, COUNT(*) AS Count from "+xeroDB+"  \
