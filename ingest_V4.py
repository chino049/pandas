        ...
        for li in CSVfClean:
            ...
            if not dry_run:
                try:
                    ...
                    record_to_insert = li[0], li[1], li[2], li[3], li[4], li[5], li[6], li[7], li[8], li[9], li[10], li[11], li[12], li[13], li[14] , li[15], li[16]
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 2:
        ...
        if len(sys.argv) > 3:
            print("For dryrun ensure the second argument is called dryrun", sys.argv[3])
            dryrun=True

        run(sys.argv[1],sys.argv[2], dryrun)
